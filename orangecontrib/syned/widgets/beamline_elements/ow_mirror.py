...
class OWMirror(OWOpticalElement):
    ...
    def draw_specific_box(self):
        ...
        self.surface_shape_box = oasysgui.widgetBox(self.tab_mir, "Surface Shape", addSpace=True, orientation="vertical")
        ...
        self.plane_box = oasysgui.widgetBox(self.surface_shape_box, "", addSpace=False, orientation="vertical", height=60)

        self.ellipsoid_box = oasysgui.widgetBox(self.surface_shape_box, "", addSpace=False, orientation="vertical", height=60)

        oasysgui.lineEdit(self.ellipsoid_box, self, "min_ax_surface", "Minor Axis [m]", labelWidth=260, valueType=float, orientation="horizontal")
        oasysgui.lineEdit(self.ellipsoid_box, self, "maj_ax_surface", "Major Axis [m]", labelWidth=260, valueType=float, orientation="horizontal")
    ...
    def set_SurfaceShape(self):
        ...
        self.ellipsoid_box.setVisible(self.surface_shape == 1)
